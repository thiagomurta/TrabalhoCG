...
function getDirectionFromAngle(angleRad) {
    ...
    if (angleDeg > -22.5 && angleDeg <= 22.5) return 'runDown';
    if (angleDeg > 22.5 && angleDeg <= 67.5) return 'runRD';
    if (angleDeg > 67.5 && angleDeg <= 112.5) return 'runRight';
    if (angleDeg > 112.5 && angleDeg <= 157.5) return 'runRU';
    if (angleDeg > 157.5 || angleDeg <= -157.5) return 'runUp';
    if (angleDeg > -157.5 && angleDeg <= -112.5) return 'runLU';
    if (angleDeg > -112.5 && angleDeg <= -67.5) return 'runLeft';
    if (angleDeg > -67.5 && angleDeg <= -22.5) return 'runLD';
